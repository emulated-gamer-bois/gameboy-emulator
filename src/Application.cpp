...
void Application::start() {
    ...
    while (running) {
        ...
        this->gui.handleGui(this->window);
...
void Application::terminate() {
    this->gui.handleGui(this->window); // TODO use gui.terminate() instead?
    terminateSDL();
}
